...
public class LoginTest {
	 ...
	 @Test
	    public void testValidEmail() {
	        ...
	        assertTrue(Connection.isValidEmail("toto@example.com"));
	        assertTrue(Connection.isValidEmail("username@domain.co"));
	        assertFalse(Connection.isValidEmail("invalid-email"));
	        assertFalse(Connection.isValidEmail("user@domain"));
	        assertFalse(Connection.isValidEmail("user@.com"));
